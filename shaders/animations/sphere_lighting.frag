...
void main() {
    ...
    // 点光源
    vec3 light_pos = vec3(2. * st_mouse.x, 2. * st_mouse.y, 3.);  // vec3(fract(u_time * 0.2) * 20. - 5., 0., 3.0);
    ...
    gl_FragColor = vec4(finale_color * (ambient_light + diffuse + specular), 1.);
